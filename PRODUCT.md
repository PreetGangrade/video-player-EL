...
- Color: near-black surfaces (#08080a stage), white type, translucent white
  glass chrome. Player accent for live/scrubber marker: violet #8B5CF6
  (RBUP player accent). Red (#DB0640) appears only where the brand ad
  templates use it. No em dashes in user-facing copy.
...
- Motion: single committed ease per transition, ease-out expo-like curves
  ...
  staggered 150-350ms delayed fades for content that follows them. Squeeze
  layouts animate the video's box deliberately (that IS the feature).
